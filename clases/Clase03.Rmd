...
```{r, echo=FALSE}
library(ggplot2)
# Simulemos un ejemplo sencillo de serie con tendencia
set.seed(42)
t <- 1:100
serie <- 0.2*t + rnorm(100, 0, 5)  # tendencia + ruido

qplot(t, serie, geom="line") +
  labs(title="Serie con tendencia",
       x="Tiempo", y="Valor")
```
...
```{r, echo=FALSE}
acf(serie, main="ACF de la serie original")
```
...
```{r, echo=FALSE}
pacf(serie, main="PACF de la serie original")
```
