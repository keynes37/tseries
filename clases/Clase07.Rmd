...
Las ecuaciones del sistema no se pueden estimar por .hi-purple[MCO] debido a la existencia de esos efectos contemporáneos $\beta_{11}$ y $\beta_{21}$ que generan .hi[endogeneidad] por doble causalidad, lo que lleva a estimar estimadores sesgados.
...
Desde luego podemos imponer un modelo .hi[estructural] de tal forma que:
