...
- Llega la hora de trabajar con [modelos estacionales]{.blut}, estos desde luego intentaran mostrar la referencia estacional en las series de tiempo.

- Se presenta la opción de [Pronostico Rápido]{.under} de `auto.arima`
:::
...
::: {.callout-warning}
## Producto de industria Manufacturera Perú
...
## Lectura
- Este modelo ya diferenciado y resumido (vamos paso adelante) nos dice que el [ACF]{.alert} cae lentamente y tenemos dos picos uno de AR y uno de MA en el lag 12 de la función de [PACF]{.blut}.
...
- Tenemos que igual revisar cada uno en test de [ruido blanco]{.fg style="--col: #FF8000}.
:::
