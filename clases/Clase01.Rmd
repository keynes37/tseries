...
| Capstone Project | Todo el semestre                     | 20%        |
| Participación    | Podcast final                        | 10%        |
...
+ Recuerde usar el **discord** de la clase para todo.
...
+ Tiene que hacerle seguimiento a una serie macroeconómica y con ella "casarse" y tratar de predecirla antes que salga el informe del DANE o del Banrep de acuerdo a las semanas que en esta se presentan, llámese .hi[informes de junta], .hi[Informe IPC], .hi[Informe de pobreza multidimensional], .hi[Tasa de interés FED], etc. 

+ Algunos estudiantes pueden tomar la **misma** serie. Pero la idea es que sean varios y con esto obtener distintos escenarios. 

+ Los trabajos a entregar son compensatorios por lo visto en clases. Pueden ser 3 o 4 en todo el .hi[semestre]

+ Lo del .hi[podcast] es totalmente obligatorio. Cada estudiante tiene un rol y de acuerdo a eso se le calificará. Los Grupos para este pueden ser conformados hasta por cuatro (4) estudiantes.

    + Desde luego deben tener una propuesta
    + Debe haber un guíon 
    + Formato mp4 o Mpeg de buena calidad (no tiene que necesariamente ser HD)
